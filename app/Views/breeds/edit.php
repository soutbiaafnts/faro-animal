    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="<?= url_to('breeds.update', $breed['id']) ?>" method="post" class="row g-2 mx-auto">
                ...
                <input type="hidden" name="species_id" value="<?= $breed['species_id'] ?>">
                <div class="col-md-6">
                    <label for="name" class="form-label">Nome</label>
                    <input name="name" value="<?= old('name', $breed['name']) ?>" type="text" id="name" placeholder="Digite o nome da raça" class="form-control <?= isset($invalidArgs['name']) ? 'is-invalid' : '' ?>">
